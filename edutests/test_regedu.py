...
class TestRegedu():
  ...
  def test_regedu(self):
    ...
    self.driver.find_element(By.ID, "new-email").send_keys("elizabeth@gmail.com")
    self.driver.find_element(By.ID, "new-username").click()
    self.driver.find_element(By.ID, "new-username").send_keys("elizabeth")
    self.driver.find_element(By.ID, "new-password").click()
    self.driver.find_element(By.ID, "new-password").send_keys("elizabethpwd")
    self.driver.find_element(By.CSS_SELECTOR, ".btn:nth-child(7)").click()
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("elizabeth")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("elizabethpwd")
