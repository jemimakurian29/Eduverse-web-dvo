...
class TestRegedu():
  ...
  def test_regedu(self):
    ...
    self.driver.find_element(By.ID, "new-email").send_keys("joshua@gmail.com")
    self.driver.find_element(By.ID, "new-username").click()
    self.driver.find_element(By.ID, "new-username").send_keys("joshua")
    self.driver.find_element(By.ID, "new-password").click()
    self.driver.find_element(By.ID, "new-password").send_keys("joshuapwd")
    ...
    self.driver.find_element(By.ID, "password").send_keys("joshuapwd")
